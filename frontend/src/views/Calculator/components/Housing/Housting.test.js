import {findAllByText, findByText, getByTestId, getByText, queryByText, render, screen, fireEvent } from '@testing-library/react'
...
describe('Component - Housing', () => {
    it('Housing should render and header should display', () => {
        ...
        screen.getByText("Enter your consumption of each type of energy, and press the Next button")
